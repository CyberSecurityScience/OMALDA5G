...
def train_dpi(list_csv_files, normalize_solution, args: Args) :
    ds = FlowDatasetTorch(list_csv_files, args, flow_dropout_ratio = args.dpi_flow_dropout_ratio, normalize_solution = normalize_solution)
